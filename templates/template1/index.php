    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading"><?php echo $previewDiffDesc; ?></h1>
                <hr>
                <p><?php echo $previewShortDesc; ?></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading"><?php echo $previewBusinessPitch; ?></h2>
                    <hr class="light">
                    <p class="text-faded"><?php echo $previewUniqueDesc?></p>
